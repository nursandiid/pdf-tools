    ...
    <section className={className}>
      ...
      <form onSubmit={submit} className="mt-6 space-y-6">
        <div className="picture relative">
          ...
          <label
            htmlFor="avatar"
            className="btn btn-blue absolute left-1/2 top-6 flex translate-x-5 cursor-pointer items-center justify-center rounded-full px-2"
            tabIndex={0}
          >
            <BsCamera />
            <input
        ...
        {mustVerifyEmail && user.email_verified_at === null && (
          <div>
            ...
            {status === "verification-link-sent" && (
              <div className="text-green mt-2 text-sm font-medium">
